...
#PRECIPITATION
#R code for filtering files from the files below
...
files <- c("NICOLASPC12", "20170622174645")
...
for(k in 1:length(files)){
  ...
  val_med <- grep("VALORES TOTALES DIARIOS DE PRECIPITACION ",all_data)
  ...
  for(i in 1:length(val_med)){
    ...
    name1 <- paste(c("prec_total_diaria_",station,"_",year,".txt"),collapse = '')
